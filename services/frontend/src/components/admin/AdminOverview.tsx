...
import {
    ...
    ShoppingBag, Percent, FileText, UserCheck,
} from 'lucide-react';
import { AreaChart, Area, ResponsiveContainer, XAxis, YAxis, CartesianGrid, Tooltip } from 'recharts';

import { DateFilterBar, DateFilterState } from '@/components/admin/DateFilterBar';
import { ADMIN_OVERVIEW_LABELS, QUOTATION_STATE_STYLES, QUOTATION_STATE_LABELS } from '@/lib/constants';
import type {
    AdminTopProduct, AdminAnalyticsData, AdminOrder,
} from '@/lib/odooClient';
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            try {
                ...
                if (dateFilter.preset) params.set('preset', dateFilter.preset);
